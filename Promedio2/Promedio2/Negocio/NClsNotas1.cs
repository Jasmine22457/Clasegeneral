...
namespace Promedio2.Negocio
{
    class NClsNotas1
    {
        ...
        public NClsNotas1(double laboratorio1, double parcial01, double laboratorio02, double parcial02, double laboratorio03, double parcial03)
        {
            ...
            promedio01 = (laboratorio1 * 0.40) + (parcial01*0.60);
            promedio02 = (laboratorio02 * 0.40) + (parcial02*0.60);
            promedi03 = (laboratorio03 * 0.40) + (parcial03 * 0.60);

            nota_final = (promedio01 + promedio02 + promedi03) / 3;
        ...
        {
            return "Su promedio obtedino del periodo 1 es :" + promedio01 + "\n" +
                   "Su promedio obtedino del periodo 2 es :" + promedio02 + "\n" +
                   "Su promedio obtedino del periodo 3 es :" + promedi03 + "\n" +
                   "El Promedio total  es :" + nota_final;
